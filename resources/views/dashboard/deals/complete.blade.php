...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> @lang("sidebar.complete_deals")</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route("dashboard.home")}}" class="default-color">@lang("sidebar.dashboard")</a></li>
                <li class="breadcrumb-item "><a href="{{route('dashboard.deals.index')}}">@lang("sidebar.deals")</a></li>
                <li class="breadcrumb-item active">@lang("sidebar.complete_deals")</li>
            </ol>
        </div>
    </div>
</div>
                                    ...
                                    <table  class="table  table-hover table-sm table-bordered p-0 text-center ">
                                        ...
                                        @foreach($deals as $i => $deal)
                                            <tr>
                                                ...
                                                <td>{{$deal->employee == NULL ? 'لا يوجد بيائع' : $deal->employee->full_name}}</td>
                                                <td>{{$deal->employee == NULL ? 'لا يوجد هاتف' : $deal->employee->phone}}</td>
                                                <td>
