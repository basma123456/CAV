                ...
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <form action="{{route("dashboard.customer.update",$customer->id)}}" method="POST" class="mt-5 col-md-12">
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" id="full_name" name="full_name" class="form-control" value="{{$customer->full_name}}">
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="number" min="0" id="nid"  name="nid" class="form-control" value="{{$customer->nid}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="address">@lang("customer.address")</label>
                                        <input type="text" min="0" id="address"  name="address" class="form-control" value="{{$customer->address}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="customer_type" id="customer_type" class="form-control p-0">
                                            ...
                                            <option value="personal" {{ $customer->customer_type == "personal"? "selected" : ''}}>@lang("customer.personal")</option>
                                            <option value="company" {{ $customer->customer_type == "company"? "selected" : ''}}>@lang("customer.company")</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="status" id="status" class="form-control p-0">
                                            <option value="" selected disabled>@lang("global.choose")</option>
                                            <option value="1" {{ $customer->status == "1"? "selected" : ''}}>@lang("global.active")</option>
                                            <option value="0" {{ $customer->status == "0"? "selected" : ''}}>@lang("global.deactivated")</option>
                                        </select>
                                    </div>
